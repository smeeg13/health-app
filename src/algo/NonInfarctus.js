...
function sommeNonInfarctus(AGE, NFUME, NSYST, NCHOL, NHDL, SEXE) {
  return (
    ...
    nChol(NCHOL, SEXE) +
    nHdl(NHDL, SEXE) +
    smokeAgeTransformed(AGE, SEXE, NFUME) +
    systAgeTransformed(AGE, SEXE, NSYST) +
    totalCholAgeTransformed(AGE, SEXE, NCHOL) +
...
function nSyst(NSYST, SEXE) {
  return SEXE === 0
    ? ((NSYST - 120) / 20) * coefSyst
    : ((NSYST - 120) / 20) * coefSystWmn;
}
