...
export class Question {
    constructor (quId,min, max,question,val_predefined,val_predefined2) {
        this.min = min;
        this.max = max;
...
export const questionConverter = {
    ...
    fromFirestore: (snapshot, options) => {
        ...
        return new Question(snapshot.id,data.min,data.max,data.question,data.val_predefined,data.val_predefined2);
    }
};